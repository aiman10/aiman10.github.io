...
<article";
        // line 70
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), "addClass", array(0 => "js-comment"), "method"), "html", null, true));
        echo ">
  ";
        // line 76
...
";
    ...
    {
        return new Twig_Source("", "core/modules/comment/templates/comment.html.twig", "C:\\wamp64\\www\\drupal\\core\\modules\\comment\\templates\\comment.html.twig");
    }
}
